...
printf "\n${BLUE}$ ./check-node-version.ts --return-exit-code${NORMAL}\n"
...
printf "\n${BLUE}$ ./check-npm-install-status/check-npm-install-status.ts --return-exit-code${NORMAL}\n"
                   ./check-npm-install-status/check-npm-install-status.ts --return-exit-code
